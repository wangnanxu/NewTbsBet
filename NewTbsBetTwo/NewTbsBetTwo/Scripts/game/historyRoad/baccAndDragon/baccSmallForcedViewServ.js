var BaccSmallForcedViewServ = function() {
	var parmas;
	...
	this.SmalllForcedView = function(number, parma,canvasid) {
			if (!number || number == 0) {
				return;
			}
			parmas = parma;
	...
	this.CanvasView = function(num, row, col) {
		...
		switch (num) {
			case 1:
				str = 'img/game/bacc/road/smallForcedTableView/red.png'
				break;
			case 2:
				str = 'img/game/bacc/road/smallForcedTableView/blue.png'
				break;
		}
		img.src = str;
